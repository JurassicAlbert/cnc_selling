...
export default async function AccountDesignsPage() {
  const [designs, favoriteDesigns] = await Promise.all([
  ...
  return (
    /*
     * One ThemeRegistry for the whole page rather than one wrapped around
            ...
            {designs.map((design) => (
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <Text muted>
                    {SITE.accountDesignsUploadedAtLabelPl}:{' '}
        ...
        <div style={{ marginBlockStart: 48 }}>
          ...
          {favoriteDesigns.length === 0 ? (
            <div style={{ marginBlockStart: 12 }}>
              ...
              <Link
                href="/kolekcje"
                style={{ display: 'inline-block', marginBlockStart: 8 }}
              >
