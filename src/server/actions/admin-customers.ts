...
/**
 * Server Action surface for `@/server/operations/admin-customers` — the thin half.
 *
...
import * as operations from '@/server/operations/admin-customers';

export type { AnonymizeCustomerResult } from '@/server/operations/admin-customers';

export async function anonymizeCustomer(
  ...args: Parameters<typeof operations.anonymizeCustomer>
): ReturnType<typeof operations.anonymizeCustomer> {
  return operations.anonymizeCustomer(...args);
}
