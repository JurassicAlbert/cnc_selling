...
/**
 * Server Action surface for `@/server/operations/admin-design-materials` — the thin half.
 *
...
import * as operations from '@/server/operations/admin-design-materials';

export type { ActionResult } from '@/server/operations/admin-design-materials';

export async function addDesignMaterial(
  ...args: Parameters<typeof operations.addDesignMaterial>
): ReturnType<typeof operations.addDesignMaterial> {
  return operations.addDesignMaterial(...args);
}

export async function removeDesignMaterial(
  ...args: Parameters<typeof operations.removeDesignMaterial>
): ReturnType<typeof operations.removeDesignMaterial> {
  return operations.removeDesignMaterial(...args);
}
