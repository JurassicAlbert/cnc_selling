...
/**
 * Server Action surface for `@/server/operations/admin-design-review` — the thin half.
 *
...
import * as operations from '@/server/operations/admin-design-review';

export type { DesignReviewDecision, DecideDesignReviewResult } from '@/server/operations/admin-design-review';

export async function decideDesignReview(
  ...args: Parameters<typeof operations.decideDesignReview>
): ReturnType<typeof operations.decideDesignReview> {
  return operations.decideDesignReview(...args);
}
