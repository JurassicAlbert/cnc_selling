...
/**
 * Server Action surface for `@/server/operations/admin-reviews` - the thin half.
 *
...
import * as operations from '@/server/operations/admin-reviews';

export async function setReviewStatus(
  ...args: Parameters<typeof operations.setReviewStatus>
): ReturnType<typeof operations.setReviewStatus> {
  return operations.setReviewStatus(...args);
}
