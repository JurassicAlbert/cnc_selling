...
/**
 * Server Action surface for `@/server/operations/admin-shipments` - the thin half.
 *
...
import * as operations from '@/server/operations/admin-shipments';

export type { ShipmentMutationResult } from '@/server/operations/admin-shipments';

export async function upsertShipment(
  ...args: Parameters<typeof operations.upsertShipment>
): ReturnType<typeof operations.upsertShipment> {
  return operations.upsertShipment(...args);
}
