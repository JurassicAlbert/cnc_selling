...
/**
 * Server Action surface for `@/server/operations/design-review` — the thin half.
 *
...
import * as operations from '@/server/operations/design-review';

export type { ReuploadCustomDesignErrorCode, ReuploadCustomDesignResult, PostCustomerDesignCommentResult } from '@/server/operations/design-review';

export async function reuploadCustomDesign(
  ...args: Parameters<typeof operations.reuploadCustomDesign>
): ReturnType<typeof operations.reuploadCustomDesign> {
  return operations.reuploadCustomDesign(...args);
}

export async function postCustomerDesignComment(
  ...args: Parameters<typeof operations.postCustomerDesignComment>
): ReturnType<typeof operations.postCustomerDesignComment> {
  return operations.postCustomerDesignComment(...args);
}
