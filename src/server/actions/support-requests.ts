...
/**
 * Server Action surface for `@/server/operations/support-requests` — the thin half.
 *
...
import * as operations from '@/server/operations/support-requests';

export type { SubmitSupportRequestResult } from '@/server/operations/support-requests';

export async function submitSupportRequest(
  ...args: Parameters<typeof operations.submitSupportRequest>
): ReturnType<typeof operations.submitSupportRequest> {
  return operations.submitSupportRequest(...args);
}

export async function submitOrderSupportRequest(
  ...args: Parameters<typeof operations.submitOrderSupportRequest>
): ReturnType<typeof operations.submitOrderSupportRequest> {
  return operations.submitOrderSupportRequest(...args);
}
