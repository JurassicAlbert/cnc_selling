...
import { AdminFormSection } from '@/ui/islands/admin/AdminFormSection';
  ...
  return (
    <form action={formAction}>
      <Stack spacing={3} sx={{ maxWidth: 880 }}>
        ...
        <AdminFormSection heading={ADMIN.productSectionCorePl}>
          <Grid container spacing={2}>
            ...
            <Grid size={{ xs: 12, sm: 6 }}>
              <TextField
                fullWidth
                label={ADMIN.productFieldNamePl}
                name="namePl"
                defaultValue={fieldValue('namePl', product?.namePl)}
                required
                size="small"
              />
            </Grid>
            <Grid size={12}>
              <TextField
                fullWidth
                label={ADMIN.productFieldShortDescPl}
                name="shortDescPl"
                defaultValue={fieldValue('shortDescPl', product?.shortDescPl)}
                size="small"
              />
            </Grid>
            <Grid size={12}>
            ...
            <Grid size={{ xs: 12, sm: 6 }}>
              <TextField
                fullWidth
                label={ADMIN.productFieldMaterialNotesPl}
                name="materialNotesPl"
                defaultValue={fieldValue('materialNotesPl', product?.materialNotesPl ?? '')}
                size="small"
              />
            </Grid>
            <Grid size={{ xs: 12, sm: 6 }}>
              <TextField fullWidth label={ADMIN.productFieldSeoTitlePl} name="seoTitlePl" defaultValue={fieldValue('seoTitlePl', product?.seoTitlePl)} size="small" />
            </Grid>
            <Grid size={12}>
              <TextField
                fullWidth
        ...
        <AdminFormSection heading={ADMIN.productSectionDimensionsPl}>
          <Grid container spacing={2}>
            <Grid size={{ xs: 6, sm: 3 }}>
              <TextField
                fullWidth
